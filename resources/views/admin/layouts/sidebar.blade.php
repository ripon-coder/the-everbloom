<aside id="sidebar-multi-level-sidebar" class="fixed top-0 md:top-[65px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">

...
@section('content')
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg max-w-4xl mx-auto">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Hero Slider</h2>
        ...
        <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-6">
                ...
                <div class="mt-4">
                    <img id="image-preview" src="{{ $slider->getImageUrl() }}" alt="Slider Preview"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="title" id="title"
                        ...
                        value="{{ old('title', $slider->title) }}" placeholder="Enter main title">
                    @error('title')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="btn_text" id="btn_text"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        value="{{ old('btn_text', $slider->btn_text) }}" placeholder="e.g. Shop Now">
                </div>
                <div>
                    ...
                    <input type="text" name="btn_link" id="btn_link"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        value="{{ old('btn_link', $slider->btn_link) }}" placeholder="e.g. /shop">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-6">
                    <div class="flex items-center">
                        <input id="status-active" type="radio" name="status" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $slider->status ? 'checked' : '' }}>
                        <label for="status-active" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Active</label>
                    </div>
                    <div class="flex items-center">
                        <input id="status-inactive" type="radio" name="status" value="0" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ !$slider->status ? 'checked' : '' }}>

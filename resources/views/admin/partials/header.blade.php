                        ...
                        <div class="app-utility-item app-user-dropdown dropdown">
                            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown"
                                href="#" role="button" aria-expanded="false"><img
                                    src="{{ asset('assets/admin/assets/images/user.png') }}" alt="user profile"></a>
                            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                ...
                                <li><button onclick="document.getElementById('admin_logout').submit()" class="dropdown-item">Log Out</button></li>
                                <form class="d-none" id="admin_logout" action="{{route('admin.logout')}}" method="POST">@csrf</form>
                            </ul>

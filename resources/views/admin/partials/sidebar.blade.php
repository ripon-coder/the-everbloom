    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2"
                    src="{{ asset('assets/admin/assets/images/app-logo.svg') }}" alt="logo"><span
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <a class="nav-link @active('admin/brand*')" href="{{ route('admin.brand.index') }}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link @active('admin/category*')" href="{{ route('admin.category.index') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/attribute*') && !request()->is('admin/attribute-value*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link @active('admin/attribute-value*')" href="{{ route('admin.attribute-value.index') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <span class="nav-link-text">Attribute Value</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                <li class="nav-item">
                    <a class="nav-link @active('admin/product*')" href="{{ route('admin.product.index') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"

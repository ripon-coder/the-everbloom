                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <nav class="flex items-center space-x-2 text-xs text-gray-500 mb-1.5">
                            ...
                            <span class="text-gray-700 font-semibold">New Category</span>
                        </nav>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-[11px] text-gray-500">Leave empty to create a top-level parent category.</p>
                                @error('parent_id')
                                    <p class="mt-1 text-[11px] text-rose-600 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" required
                                        ...
                                        <option value="{{ \App\Constants\CategoryStatus::ACTIVE }}" {{ old('status') == \App\Constants\CategoryStatus::ACTIVE ? 'selected' : '' }}>
                                            Active
                                        </option>
                                        <option value="{{ \App\Constants\CategoryStatus::INACTIVE }}" {{ old('status') == \App\Constants\CategoryStatus::INACTIVE ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3 pt-2">
                                        <label class="flex items-center space-x-1.5 text-xs text-gray-700 cursor-pointer">
                                            <input type="radio" name="is_featured" value="1" {{ old('is_featured') == '1' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-0">
                                            <span>Yes</span>
                                        </label>
                                        <label class="flex items-center space-x-1.5 text-xs text-gray-700 cursor-pointer">
                                            <input type="radio" name="is_featured" value="0" {{ old('is_featured', '0') == '0' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-0">
                                            <span>No</span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 pt-4 border-t border-gray-200">
                        ...
                        <div>
                            ...
                            <div class="p-4 border border-dashed border-gray-300 bg-gray-50/50 flex flex-col sm:flex-row items-center gap-4">
                                <img id="image-preview" src="{{ asset('images/default-logo.png') }}" alt="Category Thumbnail"
                                ...
                                <div class="space-y-1.5 text-xs">
                                    ...
                                    <p class="text-[11px] text-gray-500">Formats: JPG, PNG, WEBP. Max size: 2MB.</p>
                                </div>
                            </div>
                            @error('image')
                                <p class="mt-1 text-[11px] text-rose-600 font-medium">{{ $message }}</p>

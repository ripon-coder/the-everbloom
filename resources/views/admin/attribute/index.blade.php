@extends('admin.partials.app',['title'=>'Attributes'])
@section('content')
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Attributes</h1>
                </div>
                <div class="col-auto">
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            <div class="col-auto">
                                <a class="btn app-btn-secondary" href="{{ route('admin.attribute.create') }}">
                            ...
                            <tbody>
                                @foreach ($attributes as $item)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary" href="{{route('admin.attribute.edit',$item)}}">Edit</a>
                                    ...
                                    <form id="delete_{{$item->id}}" class="d-none" action="{{route('admin.attribute.destroy',$item)}}" method="POST">@csrf @method('DELETE')</form>
                                @endforeach
                            </tbody>
                        </table>

<section class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-col md:flex-row gap-0 rounded-2xl overflow-hidden shadow-lg border border-gray-100">
        ...
        <div class="bg-primary p-8 flex flex-col justify-center items-center text-center w-full md:w-1/4 relative overflow-hidden">
            ...
            <!-- Decorative circle -->
            <div class="absolute -bottom-10 -right-10 w-32 h-32 bg-primary-500 rounded-full blur-xl"></div>
            <div class="absolute -top-10 -left-10 w-32 h-32 bg-primary-700 rounded-full blur-xl"></div>
        </div>
        ...
        <div class="bg-white w-full md:w-3/4 p-6 relative flex items-center">
            ...
            <!-- Carousel arrows -->
            <button class="absolute left-2 w-8 h-8 bg-white border border-gray-200 rounded-full flex items-center justify-center shadow-md text-gray-500 hover:text-primary z-10">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
            </button>
            <button class="absolute right-2 w-8 h-8 bg-white border border-gray-200 rounded-full flex items-center justify-center shadow-md text-gray-500 hover:text-primary z-10">

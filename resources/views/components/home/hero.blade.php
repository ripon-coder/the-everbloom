                        ...
                        <div class="relative w-full h-[150px] sm:h-[250px] md:h-[350px] lg:h-[400px] bg-gray-100">
                            ...
                            <div class="absolute inset-0 bg-black/30 flex items-center px-8 sm:px-16 md:px-24">
                                <div class="max-w-2xl text-white space-y-3">
                                    ...
                                    @if($slider->title)
                                        <h1
                                            class="text-xl sm:text-2xl md:text-3xl font-bold leading-tight drop-shadow-md animate-fade-in-up delay-100">
                                            {{ $slider->title }}
                                        </h1>
                                    @endif
    ...
    @else
        ...
        <div
            ...
            <div class="text-center flex flex-col items-center justify-center z-20 px-4">
                ...
                <p class="text-base sm:text-xl font-bold text-slate-600 mt-2">
                    ডেলিভারি হবে <span
                        class="text-primary font-bold text-xl sm:text-3xl drop-shadow-md">সেইইইই</span> স্পিডে
                    সারা দেশে
                </p>
            </div>
        </div>

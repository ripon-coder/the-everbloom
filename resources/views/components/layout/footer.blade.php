            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <a href="mailto:{{ $site_setting->site_email ?? 'support@feriwalarhat.com' }}"
                        ...
                        <span class="text-sm font-medium">{{ $site_setting->site_email ?? 'support@feriwalarhat.com'
                            }}</span>
                    </a>
                    ...
                    <div class="flex items-start gap-3 px-4 py-3 rounded-2xl border border-gray-700 text-white group">
                        ...
                        <span
                            class="text-sm font-medium leading-relaxed">{{ $site_setting->site_address ?? 'Dhaka, Bangladesh' }}</span>
                    </div>
                </div>

                <div class="flex gap-3 mt-6">
                    @if($site_setting && $site_setting->facebook_url)
                        <a href="{{ $site_setting->facebook_url }}" target="_blank"
                            class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white hover:bg-blue-700 transition-colors">
                    ...
                    @if($site_setting && $site_setting->instagram_url)
                        <a href="{{ $site_setting->instagram_url }}" target="_blank"
                            class="w-8 h-8 rounded-full bg-pink-600 flex items-center justify-center text-white hover:bg-pink-700 transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    @if($site_setting && $site_setting->twitter_url)
                        <a href="{{ $site_setting->twitter_url }}" target="_blank"
                            class="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center text-white hover:bg-cyan-600 transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
            ...
            <div>
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        @else
                            <div class="w-14 h-14 bg-white rounded flex items-center justify-center">
                                <span class="text-xl font-bold text-slate-900">FERIWALA</span>
                            </div>
                            <span class="text-2xl font-black text-white tracking-tight">RHAT</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="space-y-4 text-gray-400 text-sm">
                    ...
                    <p class="font-medium leading-relaxed">
                        ...
                        Email: {{ $site_setting->site_email ?? 'info@feriwalarhat.com' }}
                    </p>

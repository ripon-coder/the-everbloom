<footer class="bg-slate-950 text-slate-300 pt-12 pb-8 border-t border-slate-800 mt-12">
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pb-10 border-b border-slate-800 text-xs">
            <div class="flex items-center gap-3 p-3 bg-slate-900/60 border border-slate-800">
                ...
                <div>
                    <h4 class="font-bold text-white uppercase text-[11px] tracking-wide">Free Delivery</h4>
                    <p class="text-slate-400 text-[10px]">On eligible orders</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-3 bg-slate-900/60 border border-slate-800">
                <svg class="w-6 h-6 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <h4 class="font-bold text-white uppercase text-[11px] tracking-wide">100% Genuine</h4>
                    <p class="text-slate-400 text-[10px]">Authentic products</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-3 bg-slate-900/60 border border-slate-800">
                <svg class="w-6 h-6 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <h4 class="font-bold text-white uppercase text-[11px] tracking-wide">Safe Checkout</h4>
                    <p class="text-slate-400 text-[10px]">Encrypted payment</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-3 bg-slate-900/60 border border-slate-800">
                <svg class="w-6 h-6 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <h4 class="font-bold text-white uppercase text-[11px] tracking-wide">24/7 Support</h4>
                    <p class="text-slate-400 text-[10px]">Dedicated customer help</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-10">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <span class="text-base font-bold text-white tracking-wider uppercase">{{ $site_setting->site_name ?? 'Feriwalarhat' }}</span>
                </div>
            ...
            <div>
                <h3 class="text-white font-bold uppercase tracking-wider text-xs mb-4">Quick Links</h3>
            ...
            <div>
                <h3 class="text-white font-bold uppercase tracking-wider text-xs mb-4">Customer Care</h3>
                <ul class="space-y-2.5 text-xs">
            ...
            <div class="space-y-3">
                <h3 class="text-white font-bold uppercase tracking-wider text-xs mb-4">Contact Info</h3>
        ...
        <div class="pt-6 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-slate-500">
            <p>© {{ date('Y') }} {{ $site_setting->site_name ?? 'Feriwalarhat' }}. All rights reserved.</p>
            <p>Design & Developed by <a href="#" class="text-slate-400 hover:text-primary font-medium transition-colors">{{ $site_setting->site_name ?? 'Feriwalarhat' }}</a></p>
        </div>

<div x-data="{
    ...
    <a href="{{ route('cart') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('cart') ? 'text-primary' : 'text-slate-700' }} hover:text-primary transition-colors relative">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">

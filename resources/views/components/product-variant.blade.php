<div class=" main_variant_div">
    <div class="each_div border p-4">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('discount') is-invalid @enderror" id="discount" name="sku"
                value="{{ old('discount') }}">
            @error('discount')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('discount') is-invalid @enderror" id="price" name="sku"
                value="{{ old('discount') }}">
            @error('price')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('stock') is-invalid @enderror" id="stock" name="sku"
                value="{{ old('stock') }}">
            @error('stock')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
        ...
        <div class="attribute_main p-4">
            <div class="attribute_for_variant border p-3">
                ...
                <div><a class="btn app-btn-danger" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                            height="1em" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                            <path
                                d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5M8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5m3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0" />
                        </svg></a></div>
                <div><a class="btn app-btn-primary" href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="1em"
                            height="1em" fill="currentColor" class="bi bi-plus-circle me-1" viewBox="0 0 16 16">
    ...
    <div class="variant_add_btn">
        <a class="btn app-btn-secondary" href="{{ route('admin.product.create') }}">

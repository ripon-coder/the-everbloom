...
<div class="space-y-6">
    <div class="bg-white border border-gray-200 rounded-md p-6 md:p-8">
        ...
        <p class="text-sm text-gray-600 leading-relaxed mb-6">
            From your account dashboard you can view your <a href="{{ route('account', 'orders') }}" class="text-red-600 hover:underline">recent orders</a>, manage your <a href="{{ route('account', 'addresses') }}" class="text-red-600 hover:underline">shipping and billing addresses</a>, and <a href="{{ route('account', 'details') }}" class="text-red-600 hover:underline">edit your password and account details</a>.
        </p>
        
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <a href="{{ route('account', 'orders') }}" class="border border-gray-200 rounded-md p-5 text-center hover:border-red-500 transition-all">
            ...
            <a href="{{ route('account', 'addresses') }}" class="border border-gray-200 rounded-md p-5 text-center hover:border-red-500 transition-all">
                <div class="w-12 h-12 bg-red-50 text-red-600 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <a href="{{ route('account', 'wishlist') }}" class="border border-gray-200 rounded-md p-5 text-center hover:border-red-500 transition-all">
                <div class="w-12 h-12 bg-red-50 text-red-600 rounded-full flex items-center justify-center mx-auto mb-3">

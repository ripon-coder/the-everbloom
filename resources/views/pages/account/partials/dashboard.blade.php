...
<div class="space-y-6">
    <div class="bg-white border border-gray-200 rounded-lg p-6 md:p-8 shadow-sm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <a href="{{ route('account', 'orders') }}" class="border border-gray-200 rounded-lg p-5 text-center hover:border-red-500 hover:shadow-md transition-all">
            ...
            <a href="{{ route('account', 'addresses') }}" class="border border-gray-200 rounded-lg p-5 text-center hover:border-red-500 hover:shadow-md transition-all">
                <div class="w-12 h-12 bg-red-50 text-red-600 rounded-full flex items-center justify-center mx-auto mb-3">

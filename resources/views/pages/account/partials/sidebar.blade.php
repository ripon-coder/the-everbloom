    ...
    <div class="bg-white border border-gray-200 md:border-t-0 overflow-hidden">
        ...
        <ul class="flex md:flex-col overflow-x-auto md:overflow-x-visible no-scrollbar py-2 md:py-3">
            <li class="flex-shrink-0 md:flex-shrink">
                <a href="{{ route('account', 'dashboard') }}" class="flex items-center gap-3 px-6 py-3.5 text-xs md:text-sm font-semibold uppercase tracking-wider transition-all border-b-2 md:border-b-0 md:border-l-4 {{ $section === 'dashboard' ? 'border-emerald-600 !text-emerald-700 bg-emerald-50/60' : 'border-transparent !text-gray-700 hover:!text-emerald-700 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="flex-shrink-0 md:flex-shrink">
                <a href="{{ route('account', 'orders') }}" class="flex items-center gap-3 px-6 py-3.5 text-xs md:text-sm font-semibold uppercase tracking-wider transition-all border-b-2 md:border-b-0 md:border-l-4 {{ $section === 'orders' ? 'border-emerald-600 !text-emerald-700 bg-emerald-50/60' : 'border-transparent !text-gray-700 hover:!text-emerald-700 hover:bg-gray-50' }}">
            ...
            <li class="flex-shrink-0 md:flex-shrink">
                <a href="{{ route('account', 'addresses') }}" class="flex items-center gap-3 px-6 py-3.5 text-xs md:text-sm font-semibold uppercase tracking-wider transition-all border-b-2 md:border-b-0 md:border-l-4 {{ $section === 'addresses' ? 'border-emerald-600 !text-emerald-700 bg-emerald-50/60' : 'border-transparent !text-gray-700 hover:!text-emerald-700 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    <span>Addresses</span>
                </a>
            </li>
            <li class="flex-shrink-0 md:flex-shrink">
                <a href="{{ route('account', 'wishlist') }}" class="flex items-center gap-3 px-6 py-3.5 text-xs md:text-sm font-semibold uppercase tracking-wider transition-all border-b-2 md:border-b-0 md:border-l-4 {{ $section === 'wishlist' ? 'border-emerald-600 !text-emerald-700 bg-emerald-50/60' : 'border-transparent !text-gray-700 hover:!text-emerald-700 hover:bg-gray-50' }}">
            ...
            <li class="flex-shrink-0 md:flex-shrink">
                <a href="{{ route('account', 'details') }}" class="flex items-center gap-3 px-6 py-3.5 text-xs md:text-sm font-semibold uppercase tracking-wider transition-all border-b-2 md:border-b-0 md:border-l-4 {{ $section === 'details' ? 'border-emerald-600 !text-emerald-700 bg-emerald-50/60' : 'border-transparent !text-gray-700 hover:!text-emerald-700 hover:bg-gray-50' }}">
            ...
            <li class="flex-shrink-0 md:flex-shrink border-t md:border-t border-gray-100 mt-0 md:mt-2 pt-0 md:pt-2">
                <form method="POST" action="{{ route('logout') }}" class="w-full">
                    @csrf
                    <button type="submit" class="flex items-center gap-3 w-full text-left px-6 py-3.5 text-xs md:text-sm font-semibold uppercase tracking-wider !text-red-600 hover:!text-red-700 hover:bg-red-50 transition-all border-b-2 md:border-b-0 md:border-l-4 border-transparent">

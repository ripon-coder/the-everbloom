            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-8 md:p-12 text-center" x-show="!hasSearched">
                    ...
                    <form @submit.prevent="trackOrder" class="max-w-md mx-auto text-left space-y-5">
                        <div>
                            ...
                            <input type="text" x-model="orderId" class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-primary focus:border-primary py-3" placeholder="Found in your order confirmation email" required>
                        </div>
                        <div>
                            <label class="text-[11px] font-bold text-gray-500 uppercase tracking-wide block mb-1">Billing Email *</label>
                            <input type="email" x-model="email" class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-primary focus:border-primary py-3" placeholder="Email you used during checkout" required>
                        </div>
                        <div class="pt-2">
                ...
                <div class="p-8 md:p-12" x-show="hasSearched" x-cloak>
                    <div class="flex items-center justify-between border-b border-gray-100 pb-6 mb-8">
                        <div>
                            <h2 class="text-xl font-black text-slate-900 uppercase tracking-tight mb-1">Order <span x-text="orderId" class="text-primary"></span></h2>
                            <p class="text-sm text-gray-500">Placed on October 24, 2023</p>
                        </div>
                        <button @click="hasSearched = false; orderId = ''; email = ''" class="text-[11px] font-bold text-gray-500 hover:text-primary uppercase tracking-wider transition-colors border border-gray-200 px-3 py-1.5 rounded hover:border-primary">
                            Track Another
                        </button>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="relative w-full h-2 bg-gray-100 rounded-full mb-8">
                            <div class="absolute top-0 left-0 h-full bg-primary rounded-full" style="width: 50%;"></div>
                            
                            <!-- Dots -->
                            <div class="absolute top-1/2 left-0 w-4 h-4 bg-primary border-4 border-white rounded-full -translate-y-1/2 transform shadow"></div>
                            <div class="absolute top-1/2 left-1/2 w-4 h-4 bg-primary border-4 border-white rounded-full -translate-x-1/2 -translate-y-1/2 transform shadow ring-2 ring-primary-100"></div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 leading-relaxed">
                                ...
                                <a href="#" class="text-primary hover:underline font-medium mt-1 inline-block">Track on Courier Website &rarr;</a>
                            </p>
                        </div>
                    </div>
                </div>

            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden p-8 md:p-10">
                ...
                <form class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="phone"
                               class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-primary focus:border-primary py-3 bg-gray-50" 
                    ...
                    <div>
                        ...
                        <input type="password" class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-primary focus:border-primary py-3" placeholder="Enter new password" required autofocus>
                    </div>

                    <div>
                        <label class="text-[11px] font-bold text-gray-500 uppercase tracking-wide block mb-1">Confirm New Password *</label>
                        <input type="password" class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-primary focus:border-primary py-3" placeholder="Confirm new password" required>
                    </div>

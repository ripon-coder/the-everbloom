<x-layouts.app title="Order Received | Feriwalarhat">
    ...
    <div class="bg-gray-50/70 min-h-screen py-2 md:py-2">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            
            <!-- SINGLE PRINTABLE CARD -->
            <div id="printable-order-card" class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-6 sm:p-10 space-y-8">
                    ...
                    <div class="text-center space-y-3 pb-6 border-b border-gray-100">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mx-auto border-4 border-emerald-100/80 shadow-inner">
                        ...
                        <div class="pt-2">
                            <span class="inline-flex items-center gap-2 bg-slate-900 text-white px-4 py-2 rounded-full text-xs font-mono font-bold tracking-wider shadow-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50/80 rounded-xl border border-gray-100 text-xs">
                        <div>
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center font-bold text-amber-700 bg-amber-50 border border-amber-200 px-2 py-0.5 rounded text-[11px] uppercase">
                            ...
                            @foreach($order->orderProducts as $item)
                                <div class="py-3.5 first:pt-0 last:pb-0 flex items-center justify-between gap-4">
                                    <div class="flex items-center gap-3.5">
                                        <div class="w-14 h-14 bg-gray-50 rounded-lg border border-gray-200 p-1 flex-shrink-0 flex items-center justify-center overflow-hidden">
                                            @php
                                            ...
                                            @if($item->productVariant && $item->productVariant->variantAttributes)
                                                <div class="flex flex-wrap gap-1 mt-1">
                                                    @foreach($item->productVariant->variantAttributes as $va)
                                                        <span class="inline-flex items-center text-[10px] font-semibold text-slate-700 bg-slate-100 px-2 py-0.5 rounded-full">
                    ...
                    <div class="pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 no-print">
                        ...
                        <a href="{{ route('shop') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gray-900 hover:bg-black text-white font-bold py-3 px-6 rounded-xl text-xs uppercase tracking-wider transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                            <span>Continue Shopping</span>
                        </a>

                        <button type="button" onclick="window.print()" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-3 px-5 rounded-xl text-xs uppercase tracking-wider transition-colors">

...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'buying_price' => ['required', 'numeric', 'min:0', 'decimal:0,2'],
            'sell_price' => ['required', 'numeric', 'min:0', 'decimal:0,2'],
            'discount_price' => ['nullable', 'numeric', 'min:0', 'decimal:0,2'],
    ...
    public function messages(): array
    {
        return [
            ...
            'sell_price.min' => 'The sell price must be at least 0.',

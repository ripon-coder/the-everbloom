...
class UpdateBrandRequest extends FormRequest
{
    ...
    {
        $brandId = $this->route('id'); // Get the brand ID from the route
        
        return [
            'name' => 'required|string|max:255|unique:brands,name,' . $brandId,
            'slug' => 'required|string|max:255|unique:brands,slug,' . $brandId . '|regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'descripton.string' => 'The description must be a string.',
            'descripton.max' => 'The description may not be greater than 1000 characters.',
